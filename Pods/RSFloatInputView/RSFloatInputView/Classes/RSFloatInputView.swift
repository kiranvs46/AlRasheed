...
open class RSFloatInputView: UIView {
  ...
  @IBInspectable open var idlePlaceHolderFontSize: CGFloat = 12
  @IBInspectable open var floatPlaceHolderFontSize: CGFloat = 12
  @IBInspectable open var inputFontName: String = "HelveticaNeue"
  @IBInspectable open var inputFontSize: CGFloat = 14
  ...
  @IBInspectable open var animationDuration: Double = 0.2
